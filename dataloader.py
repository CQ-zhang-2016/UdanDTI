...
from utils import generate_protein
import json
import numpy as np

class DTIDataset(data.Dataset):
    def __init__(self, list_IDs, df, LLM_type, max_drug_nodes=290):
        ...
        self.protein_map = json.load(open('./datasets/proteins.json'))
    ...
    def __getitem__(self, index):
        ...
        v_p = generate_protein(self.protein_map[seq], seq, self.LLM_type)
